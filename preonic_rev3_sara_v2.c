...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_preonic_grid(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_PLUS, KC_BSPC,
    ...
    /* Raise
     * ,-----------------------------------------------------------------------------------.
     * |      |   1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  | F10  | Del  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |  Up  |      |      |      |      |      |      |  F11 | F12  | Bksp |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * | Del  | Left | Down |Right |      |      |      |   -  |   =  |   {  |   }  |  \   |
    ...
    [_RAISE] = LAYOUT_preonic_grid(
        ...
        _______, _______, KC_UP, _______, _______, _______, _______, _______, _______, KC_F11, KC_F12, KC_BSPC,
        KC_DEL, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_BSLS,
