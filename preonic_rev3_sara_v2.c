...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_preonic_grid(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_PLUS, KC_DEL,
        KC_INS, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______,
        ...
        KC_LCTL, KC_LALT, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_MINS, KC_PLUS),
    ...
    [_RAISE] = LAYOUT_preonic_grid(
        ...
        _______, _______, KC_UP, _______, _______, _______, _______, _______, _______, KC_F11, KC_F12, KC_BSLS,
        _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_LSFT, _______, KC_TOGG, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,
        KC_LCTL, KC_LALT, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY),
